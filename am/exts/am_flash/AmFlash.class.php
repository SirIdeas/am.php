...
final class AmFlash{
  ...
  public final static function success($msg = null){

    return self::_getAdd('success', $msg);

  }

  public final static function info($msg = null){

    return self::_getAdd('info', $msg);

  }

  public final static function warning($msg = null){

    return self::_getAdd('warning', $msg);

  }

  public final static function danger($msg = null){

    return self::_getAdd('danger', $msg); 
